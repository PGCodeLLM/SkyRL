PROJECT_NAME='oh-training-qwen3-8b-sft-filtered'
EXPERIMENT_NAME='oh-training-qwen3-8b'
DATA_PATH="/shared_workspace/datasets/SkyRL-SweGymPlus-160-filtered/"
SFT_MODEL_PATH='/home/original_models/chengzong/qwen3-8b-sft-lamma-factory-1200'
